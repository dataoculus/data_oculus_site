    ...
    <>
      ...
      <section id="support" className="px-4 md:px-8 2xl:px-0">
        <div className="mx-auto max-w-c-1390 relative pt-10 lg:pt-15 xl:pt-20 px-7.5 lg:px-15 xl:px-20 overflow-hidden">
          ...
          {/*<div*/}
          {/*    className="absolute -z-1 pl-20 text-2xl rounded-lg left-0 top-0 w-full h-2/3 bg-gradient-to-t from-[#fff] to-[#dee7ff47] dark:bg-gradient-to-t dark:from-[#24283E] dark:to-[#252A42]">*/}
          {/*  Reach us*/}
          {/*</div>*/}
          ...
          <div
              className="flex flex-wrap md:flex-nowrap flex-col-reverse md:flex-row gap-4 xl:gap-20 md:justify-between">
            <Cal
                calLink="data-oculus/30min"
            ...
            <motion.div
                ...
                viewport={{once: true}}
                className="animate_top w-full md:w-2/5 lg:w-[33%] md:p-7.5 xl:pt-15"
            >
              <h2 className="text-black dark:text-white text-3xl xl:text-sectiontitle2 font-semibold mb-12.5">
                Home
              </h2>
