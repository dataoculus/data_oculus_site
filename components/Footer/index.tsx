            ...
            <div className="flex flex-wrap lg:justify-between gap-8 lg:gap-0">
              ...
              >
                ...
                <p className="mt-5 mb-10">
                  A Complete Data Observability Service.
                </p>
          ...
          <div className="border-t border-stroke dark:border-strokedark flex flex-wrap flex-col lg:flex-row items-center justify-center lg:justify-between gap-5 lg:gap-0 py-7">
            ...
            >
              <ul className="flex items-center gap-8">
                ...
                <li>
                  <a href="/tos" className="hover:text-primary">
                    Terms & Conditions
                  </a>
                </li>
                <li>
            ...
            <motion.div
              ...
              className="animate_top"
            >
              <p>&copy; 2023 Data Oculus. All rights reserved</p>
            </motion.div>
            ...
            >
              <ul className="flex items-center gap-5">
                ...
                {/*</li>*/}
                <li>
                  <a href="https://twitter.com/oculusdata">
                    <svg
                      className="fill-[#D1D8E0] hover:fill-primary transition-all duration-300"
                      width="24"
                      height="24"
                ...
                <li>
                  <a href="https://www.linkedin.com/in/data-oculus-stealth-141827285/">
                    <svg
                      className="fill-[#D1D8E0] hover:fill-primary transition-all duration-300"
                      width="24"
                      height="24"
