...
const PrivacyPolicyPage = () => {
    return (
        <div className="relative overflow-hidden pt-44">
            ...
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="relative mx-auto max-w-[37.5rem] pt-20 text-center pb-24">
                    <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">Terms and
                        Conditions</h1>
                    <p className="mt-4 text-base leading-7 text-slate-600">Last updated: August 13, 2023
                    </p>
                </div>
            </div>
            <div className="relative px-4 sm:px-6 lg:px-8">
                <div
                    ...
                    <div title="English" className="language-preview">
                        <div>
                            <div className="row">
                                <div className="col-12">
                                    <div>
                                        <p>Please read these terms and conditions carefully before using Our
                                            Service.</p>
                                        <h1 className="text-2xl mt-10 mb-6">Interpretation and Definitions</h1>
                                        <h2 className="text-xl mt-3 mb-1">Interpretation</h2>
                                        ...
                                        <h2 className="text-xl mt-3 mb-1">Definitions</h2>
                                        <p>For the purposes of these Terms and Conditions:</p>
                                        <ul className="list-disc">
                                            <li>
                                                <p><strong>Application</strong> means the software program provided by
                                                    the Company downloaded by You on any electronic device, named
                                                    Data Oculus</p>
                                            </li>
                                            <li>
                                                <p><strong>Application Store</strong> means the digital distribution
                                            ...
                                            <li>
                                                <p><strong>Company</strong> (referred to as either &quot;the
                                                    ...
                                                    this Agreement) refers to Data Oculus llc, 4532 JACODO PL DUBLIN, CA 94568.
                                                </p>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <p><strong>Terms and Conditions</strong> (also referred
                                            ...
                                            <li>
                                                <p><strong>Website</strong> refers to dataoculus.app, accessible from <a
                                                    href="https://dataoculus.app/" rel="external nofollow noopener"
                                                    target="_blank">https://dataoculus.app/</a></p>
                                            </li>
                                            <li>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">Acknowledgment</h1>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">Links to Other Websites</h1>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">Termination</h1>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">Limitation of Liability</h1>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">&quot;AS IS&quot; and &quot;AS
                                            AVAILABLE&quot; Disclaimer</h1>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">Governing Law</h1>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">Disputes Resolution</h1>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">For European Union (EU) Users</h1>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">United States Legal Compliance</h1>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">Severability and Waiver</h1>
                                        <h2 className="text-xl mt-3 mb-1">Severability</h2>
                                        ...
                                        <h2 className="text-xl mt-3 mb-1">Waiver</h2>
                                        <p>Except as provided herein, the failure to exercise a right or to require
                                            ...
                                            subsequent breach.</p>
                                        <h1 className="text-2xl mt-10 mb-6">Translation Interpretation</h1>
                                        <p>These Terms and Conditions may have been translated if We have made them
                                            ...
                                            dispute.</p>
                                        <h1 className="text-2xl mt-10 mb-6">Changes to These Terms and Conditions</h1>
                                        ...
                                        <p>By continuing to access or use Our Service after those revisions become
                                            ...
                                            Service.</p>
                                        <h1 className="text-2xl mt-10 mb-6">Contact Us</h1>
                                        <p>If you have any questions about these Terms and Conditions, You can contact
                                            us:</p>
                                        <ul className="list-disc">
                                            <li>
                                                <p>By email: info@dataoculus.app</p>
                                            </li>
                                            <li>
                                                <p>By visiting this page on our website: <a
                                                    href="dataoculus.app/contactUS" rel="external nofollow noopener"
                                                    target="_blank">dataoculus.app/contactUS</a></p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
