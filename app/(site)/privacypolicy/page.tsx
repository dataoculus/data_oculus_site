        ...
        <div className="relative overflow-hidden pt-44">
            ...
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="relative mx-auto max-w-[37.5rem] pt-20 text-center pb-24">
                    <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">Privacy policy
                    </h1>
                    <p className="mt-4 text-base leading-7 text-slate-600">Last updated on August 13, 2023
                    </p>
                </div>
            </div>
                                ...
                                <div className="col-12">
                                    <div>
                                        ...
                                        <ul className="list-disc">
                                            ...
                                            <li>
                                                <p><strong>Company</strong> (referred to as either "the Company", "We",
                                                    "Us" or "Our" in this Agreement) refers to Data Oculus LLC,
                                                    4532 JACODO PL DUBLIN, CA 94568.</p>
                                            </li>
                                            <li>
                                        ...
                                        <p>We may also collect information that Your browser sends whenever You visit
                                            ...
                                            device.</p>
                                        <h3 className="text-lg mt-2 mb-1">Tracking Technologies and Cookies</h3>
                                        ...
                                        <p>For more information about the cookies we use and your choices regarding
                                            ...
                                            Privacy Policy.</p>
                                        <h2 className="text-xl mt-3 mb-1">Use of Your Personal Data</h2>
                                        ...
                                        <h2 className="text-xl mt-3 mb-1">Retention of Your Personal Data</h2>
                                        ...
                                        <p>The Company will also retain Usage Data for internal analysis purposes. Usage
                                            ...
                                            periods.</p>
                                        <h2 className="text-xl mt-3 mb-1">Transfer of Your Personal Data</h2>
                                        ...
                                        <h2 className="text-xl mt-3 mb-1">Delete Your Personal Data</h2>
                                        ...
                                        <h2 className="text-xl mt-3 mb-1">Disclosure of Your Personal Data</h2>
                                        <h3 className="text-lg mt-2 mb-1">Business Transactions</h3>
                                        <p>If the Company is involved in a merger, acquisition or asset sale, Your
                                            Personal Data may be transferred. We will provide notice before Your
                                            Personal Data is transferred and becomes subject to a different Privacy
                                            Policy.</p>
                                        <h3 className="text-lg mt-2 mb-1">Law enforcement</h3>
                                        ...
                                        <h3 className="text-lg mt-2 mb-1">Other legal requirements</h3>
                                        ...
                                        <h2 className="text-xl mt-3 mb-1">Security of Your Personal Data</h2>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">Children's Privacy</h1>
                                        ...
                                        <h1 className="text-2xl mt-10 mb-6">Changes to this Privacy Policy</h1>
                                        ...
                                        <ul className="list-disc">
                                            <li>By email: info@dataoculus.app</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
